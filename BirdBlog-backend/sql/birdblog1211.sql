...
CREATE TABLE `bg_article_favorite` (
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_favorite_article_user` (`article_id`,`user_id`) USING BTREE,
  KEY `idx_user_id` (`user_id`) USING BTREE,
  KEY `idx_article_id` (`article_id`) USING BTREE,
  KEY `idx_create_time` (`create_time`) USING BTREE,
  KEY `idx_favorite_article_deleted` (`article_id`,`deleted`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='文章收藏表';

-- ----------------------------
-- Records of bg_article_favorite
-- ----------------------------
BEGIN;
INSERT INTO `bg_article_favorite` (`id`, `article_id`, `user_id`, `create_time`, `update_time`, `deleted`) VALUES (1, 10001, 1, '2025-12-05 23:36:17', '2025-12-05 23:36:17', b'0');
INSERT INTO `bg_article_favorite` (`id`, `article_id`, `user_id`, `create_time`, `update_time`, `deleted`) VALUES (2, 10002, 1, '2025-12-05 23:36:17', '2025-12-05 23:36:17', b'0');
INSERT INTO `bg_article_favorite` (`id`, `article_id`, `user_id`, `create_time`, `update_time`, `deleted`) VALUES (3, 10004, 1, '2025-12-05 23:36:17', '2025-12-05 23:36:17', b'0');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='文章点赞表';

-- ----------------------------
-- Records of bg_article_like
-- ----------------------------
BEGIN;
INSERT INTO `bg_article_like` (`id`, `article_id`, `user_id`, `create_time`, `update_time`, `deleted`) VALUES (1, 10001, 1, '2025-11-28 02:39:28', '2025-11-28 02:39:28', b'0');
INSERT INTO `bg_article_like` (`id`, `article_id`, `user_id`, `create_time`, `update_time`, `deleted`) VALUES (2, 10004, 1, '2025-11-28 02:39:40', '2025-11-28 02:39:40', b'0');
...
INSERT INTO `bg_article_like` (`id`, `article_id`, `user_id`, `create_time`, `update_time`, `deleted`) VALUES (4, 10002, 1, '2025-11-28 02:47:15', '2025-11-28 02:47:15', b'0');
INSERT INTO `bg_article_like` (`id`, `article_id`, `user_id`, `create_time`, `update_time`, `deleted`) VALUES (5, 10039, 1, '2025-11-28 02:48:40', '2025-11-28 02:48:40', b'0');
INSERT INTO `bg_article_like` (`id`, `article_id`, `user_id`, `create_time`, `update_time`, `deleted`) VALUES (6, 10031, 1, '2025-11-28 02:48:50', '2025-11-28 02:48:50', b'0');
INSERT INTO `bg_article_like` (`id`, `article_id`, `user_id`, `create_time`, `update_time`, `deleted`) VALUES (7, 10034, 1, '2025-11-28 02:49:34', '2025-11-28 02:49:34', b'0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `bg_article_tag` (`article_id`, `tag_id`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (10001, 101, 'author1', '2025-10-24 23:15:53', 'author1', '2025-12-05 22:13:38', b'1');
INSERT INTO `bg_article_tag` (`article_id`, `tag_id`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (10001, 103, 'author1', '2025-10-24 23:15:53', 'author1', '2025-12-05 22:13:38', b'1');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (1006, '友链审核', 1005, 1, '', NULL, 1, 'F', 1, 0, 'content:link:approval', '#', '友链审核权限（不展示菜单）', 'system', '2025-11-21 23:00:00', 'system', '2025-11-21 23:00:00', b'0');
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (2007, '角色管理', 2000, 3, 'role', 'system/role/index', 1, 'C', 0, 0, 'system:role:list', 'Avatar', '系统角色管理', 'system', '2025-11-21 23:00:00', 'system', '2025-12-11 17:56:57', b'0');
