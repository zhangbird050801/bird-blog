...
) ENGINE=InnoDB AUTO_INCREMENT=50084 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='评论表';
...
) ENGINE=InnoDB AUTO_INCREMENT=9008 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='友链';

-- ----------------------------
-- Records of bg_link
-- ----------------------------
BEGIN;
INSERT INTO `bg_link` (`id`, `name`, `logo`, `description`, `url`, `status`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (9001, '官方文档 - Spring', 'https://example.com/logo/spring.png', 'Spring 官方入口', 'https://spring.io', 0, 'admin', '2025-10-24 23:15:53', 'admin', '2025-10-24 23:15:53', b'0');
INSERT INTO `bg_link` (`id`, `name`, `logo`, `description`, `url`, `status`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (9002, 'MySQL 文档', 'https://example.com/logo/mysql.png', 'MySQL 官方文档', 'https://dev.mysql.com', 0, 'admin', '2025-10-24 23:15:53', 'admin', '2025-10-24 23:15:53', b'0');
INSERT INTO `bg_link` (`id`, `name`, `logo`, `description`, `url`, `status`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (9003, 'GitHub', 'https://example.com/logo/github.png', '开源托管平台', 'https://github.com', 0, 'admin', '2025-10-24 23:15:53', 'admin', '2025-10-24 23:15:53', b'0');
INSERT INTO `bg_link` (`id`, `name`, `logo`, `description`, `url`, `status`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (9004, '开源中国', 'https://example.com/logo/oschina.png', '开源社区', 'https://www.oschina.net', 0, 'seed', '2025-10-26 15:34:15', 'seed', '2025-10-26 15:34:15', b'0');
INSERT INTO `bg_link` (`id`, `name`, `logo`, `description`, `url`, `status`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (9005, 'InfoQ', 'https://example.com/logo/infoq.png', '技术媒体', 'https://www.infoq.cn', 0, 'seed', '2025-10-26 15:34:15', 'seed', '2025-10-26 15:34:15', b'0');
INSERT INTO `bg_link` (`id`, `name`, `logo`, `description`, `url`, `status`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (9006, '掘金', 'https://example.com/logo/juejin.png', '开发者社区', 'https://juejin.cn', 0, 'seed', '2025-10-26 15:34:15', 'seed', '2025-10-26 15:34:15', b'0');
INSERT INTO `bg_link` (`id`, `name`, `logo`, `description`, `url`, `status`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (9007, 'Stack Overflow', 'https://example.com/logo/so.png', '编程问答', 'https://stackoverflow.com', 0, 'seed', '2025-10-26 15:34:15', 'seed', '2025-10-26 15:34:15', b'0');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1006 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';

-- ----------------------------
-- Records of sys_menu
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` (`id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `status`, `perms`, `icon`, `remark`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (1000, '内容管理', NULL, 1, 'content', NULL, 1, 'M', 0, 0, NULL, 'folder', '内容管理入口', 'system', '2025-10-24 23:15:53', 'system', '2025-10-24 23:15:53', b'0');
...
INSERT INTO `sys_user` (`id`, `username`, `nick_name`, `password`, `type`, `status`, `email`, `phone`, `sex`, `avatar`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (1, 'admin', '超级管理员', '$2a$10$ITkLEsFPAQT6owS0H24HDuhBZH.VNIpNPXr2emhSpViDi.hhj3BJK', 1, 0, 'admin@birdblog.local', '18800000000', 0, 'https://example.com/avatars/admin.png', 'system', '2025-10-24 23:15:53', 'system', '2025-10-24 23:15:53', b'0');
-- 作者账号：author1 / 123456
INSERT INTO `sys_user` (`id`, `username`, `nick_name`, `password`, `type`, `status`, `email`, `phone`, `sex`, `avatar`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (2, 'author1', '小鹤', '$2a$10$XCPiZ/UEKgFhKG7hSNP0u.PegL7dxm0u.Hd3YdXm51plgqTlD0m.a', 0, 0, 'author1@birdblog.local', '18800000001', 0, 'https://example.com/avatars/author1.png', 'system', '2025-10-24 23:15:53', 'system', '2025-10-24 23:15:53', b'0');
-- 测试用户：user3-10 / 123456
INSERT INTO `sys_user` (`id`, `username`, `nick_name`, `password`, `type`, `status`, `email`, `phone`, `sex`, `avatar`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (3, 'user3', '用户3号', '$2a$10$XCPiZ/UEKgFhKG7hSNP0u.PegL7dxm0u.Hd3YdXm51plgqTlD0m.a', 0, 0, 'user3@birdblog.local', '18800000003', 0, 'https://example.com/avatars/user3.png', 'seed', '2025-10-26 15:34:10', 'seed', '2025-10-26 15:34:10', b'0');
INSERT INTO `sys_user` (`id`, `username`, `nick_name`, `password`, `type`, `status`, `email`, `phone`, `sex`, `avatar`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (4, 'user4', '用户4号', '$2a$10$XCPiZ/UEKgFhKG7hSNP0u.PegL7dxm0u.Hd3YdXm51plgqTlD0m.a', 0, 0, 'user4@birdblog.local', '18800000004', 1, 'https://example.com/avatars/user4.png', 'seed', '2025-10-26 15:34:10', 'seed', '2025-10-26 15:34:10', b'0');
INSERT INTO `sys_user` (`id`, `username`, `nick_name`, `password`, `type`, `status`, `email`, `phone`, `sex`, `avatar`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (5, 'user5', '用户5号', '$2a$10$XCPiZ/UEKgFhKG7hSNP0u.PegL7dxm0u.Hd3YdXm51plgqTlD0m.a', 0, 0, 'user5@birdblog.local', '18800000005', 2, 'https://example.com/avatars/user5.png', 'seed', '2025-10-26 15:34:10', 'seed', '2025-10-26 15:34:10', b'0');
INSERT INTO `sys_user` (`id`, `username`, `nick_name`, `password`, `type`, `status`, `email`, `phone`, `sex`, `avatar`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (6, 'user6', '用户6号', '$2a$10$XCPiZ/UEKgFhKG7hSNP0u.PegL7dxm0u.Hd3YdXm51plgqTlD0m.a', 0, 0, 'user6@birdblog.local', '18800000006', 0, 'https://example.com/avatars/user6.png', 'seed', '2025-10-26 15:34:10', 'seed', '2025-10-26 15:34:10', b'0');
INSERT INTO `sys_user` (`id`, `username`, `nick_name`, `password`, `type`, `status`, `email`, `phone`, `sex`, `avatar`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (7, 'user7', '用户7号', '$2a$10$XCPiZ/UEKgFhKG7hSNP0u.PegL7dxm0u.Hd3YdXm51plgqTlD0m.a', 0, 0, 'user7@birdblog.local', '18800000007', 1, 'https://example.com/avatars/user7.png', 'seed', '2025-10-26 15:34:10', 'seed', '2025-10-26 15:34:10', b'0');
INSERT INTO `sys_user` (`id`, `username`, `nick_name`, `password`, `type`, `status`, `email`, `phone`, `sex`, `avatar`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (8, 'user8', '用户8号', '$2a$10$XCPiZ/UEKgFhKG7hSNP0u.PegL7dxm0u.Hd3YdXm51plgqTlD0m.a', 0, 0, 'user8@birdblog.local', '18800000008', 2, 'https://example.com/avatars/user8.png', 'seed', '2025-10-26 15:34:10', 'seed', '2025-10-26 15:34:10', b'0');
INSERT INTO `sys_user` (`id`, `username`, `nick_name`, `password`, `type`, `status`, `email`, `phone`, `sex`, `avatar`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (9, 'user9', '用户9号', '$2a$10$XCPiZ/UEKgFhKG7hSNP0u.PegL7dxm0u.Hd3YdXm51plgqTlD0m.a', 0, 0, 'user9@birdblog.local', '18800000009', 0, 'https://example.com/avatars/user9.png', 'seed', '2025-10-26 15:34:10', 'seed', '2025-10-26 15:34:10', b'0');
INSERT INTO `sys_user` (`id`, `username`, `nick_name`, `password`, `type`, `status`, `email`, `phone`, `sex`, `avatar`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (10, 'user10', '用户10号', '$2a$10$XCPiZ/UEKgFhKG7hSNP0u.PegL7dxm0u.Hd3YdXm51plgqTlD0m.a', 0, 0, 'user10@birdblog.local', '18800000010', 1, 'https://example.com/avatars/user10.png', 'seed', '2025-10-26 15:34:10', 'seed', '2025-10-26 15:34:10', b'0');
-- 测试账号：sg / 1234（已修复）
...
-- 测试账号：bg / 1234（已修复）
INSERT INTO `sys_user` (`id`, `username`, `nick_name`, `password`, `type`, `status`, `email`, `phone`, `sex`, `avatar`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES (15, 'bg', 'bg333', '$2a$10$dMO8w8Pi/gQ1kpC45QW60e8mLshnEv.IquHPFZ6.goVVn8tvs0brK', 0, 0, '2341233211@qq.com', '13800138000', 1, 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fi0.hdslb.com%2Fbfs%2Farticle%2F3bf9c263bc0f2ac5c3a7feb9e218d07475573ec8.gi', 'system', '2025-10-30 15:29:46', 'system', '2025-10-30 15:46:21', b'0');
-- 管理员账号：admin1111 / admin123（已修复）
