...
CREATE TABLE `bg_article_favorite` (
  ...
  KEY `idx_favorite_article_deleted` (`article_id`,`deleted`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='文章收藏表';

-- 添加一些示例数据
INSERT INTO `bg_article_favorite` (`article_id`, `user_id`) VALUES 
(10001, 1),
(10002, 1),
(10004, 1);